...
// Practica 2. SC LIFO PRODCONS
//
// archivo: productor-consumidor_SC_LIFO.cpp
//
...
{
   cout << "--------------------------------------------------------" << endl
        << "Problema de los productores-consumidores (Monitor SC, buffer LIFO)." << endl
        << "--------------------------------------------------------" << endl
        << flush ;

  ini_contadores();

  ProdConsdScLifo monitor;
