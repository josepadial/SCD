...
//
// archivo: productor-consumidor_SU_FIFO.cpp
//
...
class ProdConsdSuFifo : public HoareMonitor{
  private:
...
ProdConsdSuFifo::ProdConsdSuFifo(){
  primera_libre = 0;
  primera_ocupada = 0;
...
int ProdConsdSuFifo::leer(int num){
...
void ProdConsdSuFifo::escribir(int valor, int num){
...
void  funcion_hebra_productora( MRef<ProdConsdSuFifo> monitor , int num)
{
...
void funcion_hebra_consumidora( MRef<ProdConsdSuFifo> monitor , int num)
{
...
int main()
{
  ...
  MRef<ProdConsdSuFifo> monitor = Create<ProdConsdSuFifo>();
